...
void SceneWIU::Update(double dt)
{
	HandleKeyPress();
	HandleMouseInput();
...
void SceneWIU::RenderMesh(Mesh* mesh, bool enableLight)
{
...
void SceneWIU::RenderMeshOnScreen(Mesh* mesh, float x, float
...
void SceneWIU::HandleMouseInput() {
...
void SceneWIU::RenderText(Mesh* mesh, std::string text, glm::vec3
	color)
{
...
void SceneWIU::RenderTextOnScreen(Mesh* mesh, std::string
